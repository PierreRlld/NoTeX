...
$\Rightarrow $ L'estimateur $\widehat{\beta}_{OLS}$ est consistant, sans biais \& asymptotiquement normal \par
$\Rightarrow $ Avec hypothèse homoscédasticité l'estimateur OLS est \textit{BLUE}
\end{boxH} 
