...
\resumeItem{Markov-Switching SVAR \textcolor{blue(pigment)}{\href{https://github.com/PierreRlld/DMLV3A/blob/main/rouillard_pierre.pdf}{literature review}}}
\resumeItem{\textcolor{blue(pigment)}{\href{https://github.com/PierreRlld/MTS3A}{Application}} of \textit{"Macro Random Forest"} by Philippe Goulet Coulombe \& al.}
\resumeItemListEnd
\vspace{.2cm}
%\resumeItemListStart
