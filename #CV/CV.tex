...
\begin{center}
    \textit{French soon to be graduated student looking for a \textbf{end of studies internship} starting June 2024}\par
    \textit{Interests: time series - economic research (macro/monetary...) }
\end{center}
...
\resumeItem{Advanced Macro: DFM, DSGE models, Recursive and Numerical methods (Julia), Machine/Deep Learning}\\
...
\resumeItem{Intragenerational mobility and income inequality - \textcolor{blue(pigment)}{\href{https://github.com/PierreRlld/NoTeX/tree/main}{Seminar of Political Economy}}}
