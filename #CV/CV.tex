...
\begin{center}
{\Large\textsc{Pierre ROUILLARD}} \\ \vspace{2pt}
...
\resumeItemListStart
\resumeItem{Macroeconomics, Labor economics, Monetary economics, Business cycle analysis, National accounting}
\resumeItem{Advanced Time-Series analysis, Macroeconometrics and Machine Learning, Advanced Macroeconomics Recursive Methods, Dynamic models with latent variables, Advanced Macroeconomics Numerical methods, GARCH and stochastic volatility models, Applied macroeconomic modelling 'Policies, the business cycle, and the green transition'}
\resumeItemListEnd
\vspace{.1cm}
%\resumeItemListStart
...
{Program in math and physics leading to nationwide entrance examinations to the \textit{Grandes Écoles}}{2018 - 2020}
...
\resumeItemListStart
\resumeItem{Supported economists in their daily tasks and researches}
\resumeItem{Including published papers on household savings and wage developments in the Eurozone}
\resumeItemListEnd
\vspace{.1cm}
...
\resumeItemListStart
\resumeItem{Produced analyses on different European real estate markets (occupier \& investment)}
...
\resumeItemListStart
\resumeItem{\textit{"Estimate consumer inflation expectations in high-frequency using alternative data"}}
\resumeItem{Natural Language Processing, CamemBERT}
\resumeItemListEnd
\vspace{.1cm}
...
\begin{itemize}
    \item[\textbf{-}] \small{"\textit{Wage dynamics: The drivers of growth}", assistant to R. Fortes PhD, \textcolor{blue(pigment)}{\href{https://www.allianz.com/content/dam/onemarketing/azcom/Allianz_com/economic-research/publications/specials/en/2023/may/2023-05-03-LaborMarkets.pdf}{Allianz Trade research}}, May 2023}
...
\small{\item{
\textbf{Coding}{: Python, R, Excel, Eviews, Dynare} \\
