...
\resumeItem{Advanced Macro: Machine Learning, Recursive methods, Applied macroeconometrics}
\resumeItem{Advanced Time series: Structural VAR, Dynamic models with latent variables, GARCH and stochastic volatility models}
\resumeItemListEnd
