...
\begin{center}
    \textit{French soon to be graduated student looking for a end of studies internship/full time position starting June 2024}\par
...
\resumeItemListStart
\resumeItem{\textcolor{blue(pigment)}{\textit{\href{https://github.com/PierreRlld/SVAR3A}{"SVAR-based supply and demand decomposition of inflation"}}} - [\textcolor{blue(pigment)}{\textit{\href{https://github.com/PierreRlld/SVAR3A/blob/main/notes/main.pdf}{report}}},\textcolor{blue(pigment)}{\textit{\href{https://pierrerlld-svar3a-mainstreamlit-app-qy5le2.streamlit.app/?embed_options=light_theme}{code}}}]}
\resumeItem{Currently working on 'The Macroeconomy as a Random Forest' Philippe Goulet Coulombe \& al.}
\resumeItem{Currently working on a Markov-switching ARMA project}
\resumeItemListEnd
\vspace{.1cm}
%\resumeItemListStart
